...
##Vegan Set-up
```{r}
###Group main Data by Set, Box, Rarity, Card Type, Finish, Total number and Price
MTG_Vegan <- MTG %>%
  group_by(set, rep, rarity, card_type, card_name, finish, total, price) 
